...
export const translations: Record<Language, Translations> = {
  ...
  ar: {
    ...
    customerHero: {
      ...
      subheadline:
        'تجربة معرض متنقل توصّل لك براندات عالمية حصرية في مولات ومواقع في السعودية.',
      primaryCta: 'لقّي المعرض القادم',
